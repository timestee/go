...
// package core of Tideland Go Library provides types for the
// implementation of servers with a RESTful API. The business logic
// has to be implemented in types fullfilling the ResourceHandler
// interface. This basic interface only allows the initialization of
// the handler. More interesting are the other interfaces like
// GetResourceHandler which defines the Get() method for the HTTP request
// method GET. Others are for PUT, POST, HEAD, PATCH, DELETE, and OPTIONS.
// Their according methods get a Job as argument. It provides convenient
